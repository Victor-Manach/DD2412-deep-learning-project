...
class TrainModule:
    def __init__(self, model, length_train_data, exmp_imgs, dataset_name, model_arch, num_epochs, seed=42):
        super().__init__()
        self.seed = seed
        ...
        # Initialize model
        self.init_model(length_train_data)
    ...
    def init_model(self, length_train_data):
        ...
        lr_schedule = optax.warmup_cosine_decay_schedule(
            ...
            peak_value=1e-3,
            warmup_steps=100,
            decay_steps=500*length_train_data,
            end_value=1e-5
        )
